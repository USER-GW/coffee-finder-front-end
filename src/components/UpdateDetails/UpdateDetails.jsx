...
const UpdateDetails = (props) => {
  ...
  console.log('UpdateDetails _id:', _id);
  ...
  useEffect(() => {
    const fetchCoffee = async () => {
      try {
        const coffeeDataFromServer = await coffeeService.show(_id);
        console.log('Fetched data:', coffeeDataFromServer);
        
        // Ensure you're accessing the correct data
 ...
 const handleChange = (event) => {
   ...
   const handleSubmit = (evt) => {
    evt.preventDefault();
    if (_id){
    props.handleUpdateShop(_id, formData);
    }
